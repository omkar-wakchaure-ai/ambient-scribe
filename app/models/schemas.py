...
# ---------------------------------------------------------------
# Patient-scoped reports (consumed by the frontend reports/history UI)
# ---------------------------------------------------------------

class PatientConsultationReport(BaseModel):
    job_id: str
    patient_id: str
    appointment_id: Optional[str] = None
    status: str
    ...
    soap_note: str = ""
    actions: Optional[ActionSummary] = None


class PatientReportsResponse(BaseModel):
    patient_id: str
    reports: List[PatientConsultationReport] = Field(default_factory=list)
